    ...
    <div>
      ...
      <div className="detail">
        <div className="small-image-container">
          {productDetails &&
            productDetails.smallImage.map((img) => (
        ...
        <div className="main-img" style={{marginTop:'none'}}>
        ...
        <div className="desc">
          ...
          <div className="cloth-desc">
            <p>
              Introducing a luxurious blend of cashmere and silk, this versatile
              accessory exudes elegance and comfort. With its timeless design
              and unmatched softness, it effortlessly elevates any ensemble.
            </p>
          </div>
          ...
          <p className="category">
            <b>Category: </b> {productDetails.gender}{" "}
          </p>
          <p className="category">
